        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Yearwise Expense Report Details</div>
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <?php 
                                ...
                                $tdate = $_POST['todate'];
                            ?>
                            <h5 align="center" style="color:slateblue">Yearwise Expense Report From <?php echo $fdate; ?> to <?php echo $tdate; ?></h5>
                            <hr>
                            <table class="table table-bordered dt-responsive nowrap" style="border-collapse:collapse;">
                                ...
                                <?php 
                                    ...
                                    $result = mysqli_query($conn, "SELECT year(expense_date) AS rptyear, sum(cost) AS totalyear 
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $total_expense_list = $row['totalyear'] ?></td>
                                </tr>
                                <?php 
